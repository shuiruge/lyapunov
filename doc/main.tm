...
<\body>
  ...
  <\lemma>
    If <math|K<rsup|a b><around*|(|x|)>> is everywhere positive definite,
    then Markov chains generated by the SDE

    <\equation*>
      \<mathd\>X<rsup|a>=<around*|[|-K<rsup|a b><around*|(|x|)>
      \<nabla\><rsub|b>E<around*|(|x|)>+T \<nabla\><rsub|b> K<rsup|a
      b><around*|(|x|)>|]> \<mathd\>t+<sqrt|2T> \<mathd\>V<rsup|a>,
    </equation*>

    where

    <\equation*>
      \<mathd\>V<rsup|a>\<sim\><with|font|cal|N><around*|(|0,K<rsup|a
      b><around*|(|x|)> \<mathd\>t|)>,
    </equation*>

    relaxes to <math|q<rsub|E>>.
  </lemma>
  ...
  <small|<\proof>
    ...
    <\align>
      ...
      <around*|(|f<rsup|a><around*|(|x|)>+T \<nabla\><rsub|b> K<rsup|a
      b><around*|(|x|)>|)>|]>+T \<nabla\><rsub|a>\<nabla\><rsub|b><around*|[|p<around*|(|x,t|)>
      K<rsup|a b><around*|(|x|)>|]>>>|<row|<cell|=>|<cell|\<nabla\><rsub|a><around*|{|p<around*|(|x,t|)>
      <around*|[|-f<rsup|a><around*|(|x|)>+T \<nabla\><rsub|b>ln
      p<around*|(|x,t|)> K<rsup|a b><around*|(|x|)>|]>|}>>>|<row|<cell|=>|<cell|\<nabla\><rsub|a><around*|{|p<around*|(|x,t|)>
      K<rsup|a b><around*|(|x|)> \<nabla\><rsub|b><around*|[|E<around*|(|x|)>+T
      ln p<around*|(|x,t|)>|]>|}>>>>>
    </align>
    ...
    <\align>
      <tformat|<table|<row|<cell|<frac|\<mathd\>|\<mathd\>t>T
      D<rsub|KL><around*|(|p\<\|\|\>q<rsub|E>|)>=>|<cell|<frac|\<mathd\>|\<mathd\>t><around*|[|T<big|int><rsub|<with|font|cal|M>>\<mathd\>\<mu\><around*|(|x|)>
      p<around*|(|x,t|)> ln <frac|p<around*|(|x,t|)>|q<rsub|E><around*|(|x|)>>|]>>>|<row|<cell|=>|<cell|T<big|int><rsub|<with|font|cal|M>>\<mathd\>\<mu\><around*|(|x|)>
      <frac|\<partial\>p|\<partial\>t><around*|(|x,t|)> <around*|[|ln
      <frac|p<around*|(|x,t|)>|q<rsub|E><around*|(|x|)>>+1|]>>>|<row|<cell|<around*|{|<frac|\<partial\>p|\<partial\>t><around*|(|x,t|)>=\<cdots\>|}>=>|<cell|T<big|int><rsub|<with|font|cal|M>>\<mathd\>\<mu\><around*|(|x|)>
      \<nabla\><rsub|a><around*|{|p<around*|(|x,t|)> K<rsup|a
      b><around*|(|x|)> \<nabla\><rsub|b><around*|[|E<around*|(|x|)>+T ln
      p<around*|(|x,t|)>|]>|}> <around*|[|ln
      <frac|p<around*|(|x,t|)>|q<rsub|E><around*|(|x|)>>+1|]>>>|<row|<cell|<around*|{|Integral
      by part|}>=>|<cell|-<big|int><rsub|<with|font|cal|M>>\<mathd\>\<mu\><around*|(|x|)>
      p<around*|(|x,t|)> K<rsup|a b><around*|(|x|)>
      \<nabla\><rsub|b><around*|[|E<around*|(|x|)>+T ln
      p<around*|(|x,t|)>|]>\<nabla\><rsub|a><around*|[|E<around*|(|x|)>+T ln
      p(x; t)|]>.>>>>
    </align>

    Since <math|K<rsup|a b><around*|(|x|)> p<around*|(|x,t|)>> is everywhere
    positive definite on the support of <math|p<around*|(|x,t|)>>, then we
    have

    <\equation*>
      <frac|\<mathd\>|\<mathd\>t>T D<rsub|KL><around*|(|p\<\|\|\>q<rsub|E>|)>\<leqslant\>0
    </equation*>

    and the equality holds only when <math|\<nabla\><rsub|a><around*|[|T ln
    p(x; t) + E<around*|(|x|)>|]>=0>, that is,
    <math|p<around*|(|\<cdummy\>,t|)>=q<rsub|E>>. That is,
    <math|p<around*|(|\<cdummy\>,t|)>> relaxes to <math|q<rsub|E>>.
  </proof>>
...
<\references>
  <\collection>
    ...
    <associate|auto-10|<tuple|B.2|?>>
    <associate|auto-11|<tuple|B.2|?>>
    ...
    <associate|auto-9|<tuple|B.1|?>>
    <associate|definition: SDE|<tuple|10|5>>
    ...
    <associate|lemma: Kramers\UMoyal Expansion|<tuple|8|3>>
    <associate|lemma: Macroscopic Landscape|<tuple|11|5>>
  </collection>
</references>
